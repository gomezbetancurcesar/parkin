...
namespace CapaDatos
{
    public class Tarjeta
    {
        ...
        public int guardar(Tarjeta tarjeta)
        {
            ...
            string query = "insert into TARJETAS (COD_TARJETA, NUMERO_TARJETA, SALDO, COD_BANCO, COD_TARJETA_TIPO,COD_USUARIO,EXPIRACION,CVV) values (";
            query += cod + ",";
        ...
        public List<Tarjeta> buscarTodos(int codUsuario = 0)
        {
            ...
            while (dr.Read())
            {
                ...
                tarjeta.expiracion = dr["expiracion"].ToString();
